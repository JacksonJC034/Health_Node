...
bool pkg00_base_interfaces__msg__core_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pkg00_base_interfaces.msg._core_info.CoreInfo", full_classname_dest, 45) == 0);
  }
  pkg00_base_interfaces__msg__CoreInfo * ros_message = _ros_message;
  {  // cpu_usage
...
PyObject * pkg00_base_interfaces__msg__core_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pkg00_base_interfaces.msg._core_info");
