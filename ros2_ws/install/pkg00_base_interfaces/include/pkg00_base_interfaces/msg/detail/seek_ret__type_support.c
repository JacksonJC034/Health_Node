...
#include <stddef.h>
#include "pkg00_base_interfaces/msg/detail/seek_ret__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  pkg00_base_interfaces__msg__SeekRet__init(message_memory);
}

void SeekRet__rosidl_typesupport_introspection_c__SeekRet_fini_function(void * message_memory)
{
  pkg00_base_interfaces__msg__SeekRet__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SeekRet__rosidl_typesupport_introspection_c__SeekRet_message_member_array[1] = {
  {
    ...
    offsetof(pkg00_base_interfaces__msg__SeekRet, ret),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers SeekRet__rosidl_typesupport_introspection_c__SeekRet_message_members = {
  ...
  1,  // number of fields
  sizeof(pkg00_base_interfaces__msg__SeekRet),
