...
#ifndef BASE_INTERFACES_DEMO__MSG__DETAIL__CORE_INFO__FUNCTIONS_H_
#define BASE_INTERFACES_DEMO__MSG__DETAIL__CORE_INFO__FUNCTIONS_H_
 ...
 * calls
 * base_interfaces_demo__msg__CoreInfo__init().
...
/**
 * It calls
 * base_interfaces_demo__msg__CoreInfo__fini()
 ...
 * base_interfaces_demo__msg__CoreInfo__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * base_interfaces_demo__msg__CoreInfo__Sequence__fini()
 * on the array,
...
#endif  // BASE_INTERFACES_DEMO__MSG__DETAIL__CORE_INFO__FUNCTIONS_H_
