...
#ifndef BASE_INTERFACES_DEMO__MSG__DETAIL__DEVICE_INFO__FUNCTIONS_H_
#define BASE_INTERFACES_DEMO__MSG__DETAIL__DEVICE_INFO__FUNCTIONS_H_
 ...
 * calls
 * base_interfaces_demo__msg__DeviceInfo__init().
...
/**
 * It calls
 * base_interfaces_demo__msg__DeviceInfo__fini()
 ...
 * base_interfaces_demo__msg__DeviceInfo__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * base_interfaces_demo__msg__DeviceInfo__Sequence__fini()
 * on the array,
...
#endif  // BASE_INTERFACES_DEMO__MSG__DETAIL__DEVICE_INFO__FUNCTIONS_H_
