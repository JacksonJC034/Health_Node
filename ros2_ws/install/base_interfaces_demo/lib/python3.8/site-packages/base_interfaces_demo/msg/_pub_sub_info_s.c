...
bool base_interfaces_demo__msg__pub_sub_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces_demo.msg._pub_sub_info.PubSubInfo", full_classname_dest, 49) == 0);
  }
  base_interfaces_demo__msg__PubSubInfo * ros_message = _ros_message;
  {  // current_x
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * base_interfaces_demo__msg__pub_sub_info__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of PubSubInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces_demo.msg._pub_sub_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PubSubInfo");
  ...
  base_interfaces_demo__msg__PubSubInfo * ros_message = (base_interfaces_demo__msg__PubSubInfo *)raw_ros_message;
  {  // current_x
    PyObject * field = NULL;
