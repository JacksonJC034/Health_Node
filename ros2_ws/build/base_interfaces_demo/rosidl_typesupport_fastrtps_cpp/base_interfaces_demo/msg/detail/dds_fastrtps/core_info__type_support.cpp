...
#include "base_interfaces_demo/msg/detail/core_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const base_interfaces_demo::msg::CoreInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  base_interfaces_demo::msg::CoreInfo & ros_message)
{
  // Member: cpu_usage
  cdr >> ros_message.cpu_usage;
...
{
  auto typed_message =
    static_cast<const base_interfaces_demo::msg::CoreInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_interfaces_demo::msg::CoreInfo *>(
    untyped_ros_message);
...
{
  return &base_interfaces_demo::msg::typesupport_fastrtps_cpp::_CoreInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, base_interfaces_demo, msg, CoreInfo)() {
  return &base_interfaces_demo::msg::typesupport_fastrtps_cpp::_CoreInfo__handle;
}
