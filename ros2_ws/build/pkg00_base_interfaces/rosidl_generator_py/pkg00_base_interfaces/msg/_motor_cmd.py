    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'pkg00_base_interfaces.msg.MotorCmd')
            logger.debug(
...
class MotorCmd(metaclass=Metaclass_MotorCmd):
    ...
    def dec(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'dec' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'dec' field must be an integer in [-2147483648, 2147483647]"
        self._dec = value
    ...
    def control(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'control' field must be an integer in [-2147483648, 2147483647]"
        self._control = value
    ...
    def location(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'location' field must be an integer in [-2147483648, 2147483647]"
