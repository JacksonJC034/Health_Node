...
bool pkg00_base_interfaces__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pkg00_base_interfaces.msg._system_status.SystemStatus", full_classname_dest, 53) == 0);
  }
  pkg00_base_interfaces__msg__SystemStatus * ros_message = _ros_message;
  {  // system_mode
...
PyObject * pkg00_base_interfaces__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pkg00_base_interfaces.msg._system_status");
