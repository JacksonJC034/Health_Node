...
#include "pkg00_base_interfaces/msg/detail/motor_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pkg00_base_interfaces::msg::MotorCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pkg00_base_interfaces::msg::MotorCmd & ros_message)
{
  // Member: speed
  cdr >> ros_message.speed;
...
{
  auto typed_message =
    static_cast<const pkg00_base_interfaces::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pkg00_base_interfaces::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  return &pkg00_base_interfaces::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pkg00_base_interfaces, msg, MotorCmd)() {
  return &pkg00_base_interfaces::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
