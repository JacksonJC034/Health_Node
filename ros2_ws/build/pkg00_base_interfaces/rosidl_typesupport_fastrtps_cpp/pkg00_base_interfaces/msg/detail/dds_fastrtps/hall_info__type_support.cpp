...
#include "pkg00_base_interfaces/msg/detail/hall_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pkg00_base_interfaces::msg::HallInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pkg00_base_interfaces::msg::HallInfo & ros_message)
{
  // Member: uid7
  cdr >> ros_message.uid7;
...
{
  auto typed_message =
    static_cast<const pkg00_base_interfaces::msg::HallInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pkg00_base_interfaces::msg::HallInfo *>(
    untyped_ros_message);
...
{
  return &pkg00_base_interfaces::msg::typesupport_fastrtps_cpp::_HallInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pkg00_base_interfaces, msg, HallInfo)() {
  return &pkg00_base_interfaces::msg::typesupport_fastrtps_cpp::_HallInfo__handle;
}
