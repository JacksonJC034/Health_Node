...
static const _SystemStatus_type_support_symbol_names_t _SystemStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pkg00_base_interfaces, msg, SystemStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pkg00_base_interfaces, msg, SystemStatus)),
  }
};
...
{
  return &::pkg00_base_interfaces::msg::rosidl_typesupport_cpp::SystemStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pkg00_base_interfaces, msg, SystemStatus)() {
  return get_message_type_support_handle<pkg00_base_interfaces::msg::SystemStatus>();
}
