...
static const _ChargerInfo_type_support_symbol_names_t _ChargerInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pkg00_base_interfaces, msg, ChargerInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pkg00_base_interfaces, msg, ChargerInfo)),
  }
};
...
{
  return &::pkg00_base_interfaces::msg::rosidl_typesupport_cpp::ChargerInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pkg00_base_interfaces, msg, ChargerInfo)() {
  return get_message_type_support_handle<pkg00_base_interfaces::msg::ChargerInfo>();
}
