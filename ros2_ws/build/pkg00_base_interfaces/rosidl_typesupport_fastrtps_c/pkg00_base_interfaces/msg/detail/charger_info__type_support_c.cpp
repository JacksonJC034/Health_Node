...
#include "pkg00_base_interfaces/msg/detail/charger_info__rosidl_typesupport_fastrtps_c.h"
...
using _ChargerInfo__ros_msg_type = pkg00_base_interfaces__msg__ChargerInfo;
...
size_t get_serialized_size_pkg00_base_interfaces__msg__ChargerInfo(
  const void * untyped_ros_message,
...
static uint32_t _ChargerInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pkg00_base_interfaces__msg__ChargerInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pkg00_base_interfaces
size_t max_serialized_size_pkg00_base_interfaces__msg__ChargerInfo(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_pkg00_base_interfaces__msg__ChargerInfo(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pkg00_base_interfaces, msg, ChargerInfo)() {
