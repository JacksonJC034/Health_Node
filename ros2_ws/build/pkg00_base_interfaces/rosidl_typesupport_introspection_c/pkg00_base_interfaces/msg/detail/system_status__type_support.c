...
#include <stddef.h>
#include "pkg00_base_interfaces/msg/detail/system_status__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  pkg00_base_interfaces__msg__SystemStatus__init(message_memory);
}

void SystemStatus__rosidl_typesupport_introspection_c__SystemStatus_fini_function(void * message_memory)
{
  pkg00_base_interfaces__msg__SystemStatus__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SystemStatus__rosidl_typesupport_introspection_c__SystemStatus_message_member_array[2] = {
  {
    ...
    offsetof(pkg00_base_interfaces__msg__SystemStatus, system_mode),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pkg00_base_interfaces__msg__SystemStatus, work_status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SystemStatus__rosidl_typesupport_introspection_c__SystemStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(pkg00_base_interfaces__msg__SystemStatus),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pkg00_base_interfaces, msg, SystemStatus)() {
