...
pkg00_base_interfaces__msg__SeekRet__create()
{
  ...
  pkg00_base_interfaces__msg__SeekRet * msg = (pkg00_base_interfaces__msg__SeekRet *)allocator.allocate(sizeof(pkg00_base_interfaces__msg__SeekRet), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pkg00_base_interfaces__msg__SeekRet));
  bool success = pkg00_base_interfaces__msg__SeekRet__init(msg);
  if (!success) {
...
pkg00_base_interfaces__msg__SeekRet__destroy(pkg00_base_interfaces__msg__SeekRet * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    pkg00_base_interfaces__msg__SeekRet__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
pkg00_base_interfaces__msg__SeekRet__Sequence__init(pkg00_base_interfaces__msg__SeekRet__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pkg00_base_interfaces__msg__SeekRet * data = NULL;

  if (size) {
    data = (pkg00_base_interfaces__msg__SeekRet *)allocator.zero_allocate(size, sizeof(pkg00_base_interfaces__msg__SeekRet), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pkg00_base_interfaces__msg__SeekRet__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        pkg00_base_interfaces__msg__SeekRet__fini(&data[i - 1]);
      }
...
pkg00_base_interfaces__msg__SeekRet__Sequence__fini(pkg00_base_interfaces__msg__SeekRet__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      pkg00_base_interfaces__msg__SeekRet__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pkg00_base_interfaces__msg__SeekRet__Sequence * array = (pkg00_base_interfaces__msg__SeekRet__Sequence *)allocator.allocate(sizeof(pkg00_base_interfaces__msg__SeekRet__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pkg00_base_interfaces__msg__SeekRet__Sequence__init(array, size);
  if (!success) {
...
pkg00_base_interfaces__msg__SeekRet__Sequence__destroy(pkg00_base_interfaces__msg__SeekRet__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pkg00_base_interfaces__msg__SeekRet__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pkg00_base_interfaces__msg__SeekRet__Sequence__are_equal(const pkg00_base_interfaces__msg__SeekRet__Sequence * lhs, const pkg00_base_interfaces__msg__SeekRet__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pkg00_base_interfaces__msg__SeekRet__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pkg00_base_interfaces__msg__SeekRet__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pkg00_base_interfaces__msg__SeekRet);
    pkg00_base_interfaces__msg__SeekRet * data =
      (pkg00_base_interfaces__msg__SeekRet *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pkg00_base_interfaces__msg__SeekRet__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          pkg00_base_interfaces__msg__SeekRet__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!pkg00_base_interfaces__msg__SeekRet__copy(
