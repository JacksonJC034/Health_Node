...
#ifndef PKG00_BASE_INTERFACES__MSG__DETAIL__BMS_INFO__STRUCT_HPP_
#define PKG00_BASE_INTERFACES__MSG__DETAIL__BMS_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__pkg00_base_interfaces__msg__BmsInfo __attribute__((deprecated))
#else
# define DEPRECATED__pkg00_base_interfaces__msg__BmsInfo __declspec(deprecated)
#endif
...
struct BmsInfo_
{
  ...
  // pointer types
  using RawPtr =
    pkg00_base_interfaces::msg::BmsInfo_<ContainerAllocator> *;
  using ConstRawPtr =
    const pkg00_base_interfaces::msg::BmsInfo_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<pkg00_base_interfaces::msg::BmsInfo_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<pkg00_base_interfaces::msg::BmsInfo_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      pkg00_base_interfaces::msg::BmsInfo_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<pkg00_base_interfaces::msg::BmsInfo_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<pkg00_base_interfaces::msg::BmsInfo_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<pkg00_base_interfaces::msg::BmsInfo_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<pkg00_base_interfaces::msg::BmsInfo_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__pkg00_base_interfaces__msg__BmsInfo
    std::shared_ptr<pkg00_base_interfaces::msg::BmsInfo_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__pkg00_base_interfaces__msg__BmsInfo
    std::shared_ptr<pkg00_base_interfaces::msg::BmsInfo_<ContainerAllocator> const>
...
using BmsInfo =
  pkg00_base_interfaces::msg::BmsInfo_<std::allocator<void>>;
...
#endif  // PKG00_BASE_INTERFACES__MSG__DETAIL__BMS_INFO__STRUCT_HPP_
