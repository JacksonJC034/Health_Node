...
#include <stddef.h>
#include "pkg00_base_interfaces/msg/detail/core_info__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  pkg00_base_interfaces__msg__CoreInfo__init(message_memory);
}

void CoreInfo__rosidl_typesupport_introspection_c__CoreInfo_fini_function(void * message_memory)
{
  pkg00_base_interfaces__msg__CoreInfo__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember CoreInfo__rosidl_typesupport_introspection_c__CoreInfo_message_member_array[6] = {
  {
    ...
    offsetof(pkg00_base_interfaces__msg__CoreInfo, cpu_usage),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pkg00_base_interfaces__msg__CoreInfo, memory_usage),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pkg00_base_interfaces__msg__CoreInfo, disk_usage),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pkg00_base_interfaces__msg__CoreInfo, cpu_frequency),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pkg00_base_interfaces__msg__CoreInfo, nic_status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pkg00_base_interfaces__msg__CoreInfo, temperature),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CoreInfo__rosidl_typesupport_introspection_c__CoreInfo_message_members = {
  ...
  6,  // number of fields
  sizeof(pkg00_base_interfaces__msg__CoreInfo),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pkg00_base_interfaces, msg, CoreInfo)() {
