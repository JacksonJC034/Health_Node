...
{
  new (message_memory) pkg00_base_interfaces::msg::SeekRet(_init);
}

void SeekRet_fini_function(void * message_memory)
{
  auto typed_message = static_cast<pkg00_base_interfaces::msg::SeekRet *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SeekRet_message_member_array[1] = {
  {
    ...
    offsetof(pkg00_base_interfaces::msg::SeekRet, ret),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SeekRet_message_members = {
  ...
  1,  // number of fields
  sizeof(pkg00_base_interfaces::msg::SeekRet),
...
{
  return &::pkg00_base_interfaces::msg::rosidl_typesupport_introspection_cpp::SeekRet_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pkg00_base_interfaces, msg, SeekRet)() {
  return &::pkg00_base_interfaces::msg::rosidl_typesupport_introspection_cpp::SeekRet_message_type_support_handle;
}
