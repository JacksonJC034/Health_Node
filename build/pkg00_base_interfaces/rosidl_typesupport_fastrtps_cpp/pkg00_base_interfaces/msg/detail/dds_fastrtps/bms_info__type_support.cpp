...
#include "pkg00_base_interfaces/msg/detail/bms_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pkg00_base_interfaces::msg::BmsInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pkg00_base_interfaces::msg::BmsInfo & ros_message)
{
  // Member: cell_num
  cdr >> ros_message.cell_num;
...
{
  auto typed_message =
    static_cast<const pkg00_base_interfaces::msg::BmsInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pkg00_base_interfaces::msg::BmsInfo *>(
    untyped_ros_message);
...
{
  return &pkg00_base_interfaces::msg::typesupport_fastrtps_cpp::_BmsInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pkg00_base_interfaces, msg, BmsInfo)() {
  return &pkg00_base_interfaces::msg::typesupport_fastrtps_cpp::_BmsInfo__handle;
}
