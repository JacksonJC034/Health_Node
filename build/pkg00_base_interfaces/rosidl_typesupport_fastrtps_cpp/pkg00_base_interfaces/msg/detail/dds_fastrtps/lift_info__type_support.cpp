...
#include "pkg00_base_interfaces/msg/detail/lift_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const pkg00_base_interfaces::msg::LiftInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pkg00_base_interfaces::msg::LiftInfo *>(
    untyped_ros_message);
...
{
  return &pkg00_base_interfaces::msg::typesupport_fastrtps_cpp::_LiftInfo__handle;
}
